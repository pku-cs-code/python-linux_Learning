# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-09-04 06:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iface_type', models.CharField(max_length=64, verbose_name='接口类型')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Sansa.Asset')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='事件负责人')),
            ],
        ),
        migrations.CreateModel(
            name='IDC',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved_date', models.DateTimeField(auto_now_add=True, verbose_name='批准日期')),
                ('approved_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='批准人')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('macaddress', models.CharField(max_length=64, unique=True, verbose_name='MAX')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(max_length=128, null=True, verbose_name='型号')),
                ...
                ('raid_adaptor', models.ManyToManyField(to='Sansa.RaidAdaptor')),
            ],
            options={
                'verbose_name': '服务器',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, choices=[('linux', 'Linux'), ('windows', 'Windows'), ('network_firmware', 'Network Firmware'), ('software', 'Softwares')], max_length=64, null=True, verbose_name='系统类型')),
                ('distribution', models.CharField(blank=True, choices=[('windows', 'Windows'), ('centos', 'CentOS'), ('ubuntu', 'Ubuntu')], max_length=64, null=True, verbose_name='发行版本')),
                ('version', models.CharField(blank=True, max_length=64, null=True, verbose_name='软件/系统版本')),
                ('language', models.CharField(blank=True, choices=[('cn', '中文'), ('en', '英文')], max_length=64, null=True, verbose_name='系统语言')),
            ],
            options={
                'verbose_name': '软件/系统',
        ...
        migrations.AddField(
            model_name='asset',
            name='manufactory',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Sansa.Manufactory', verbose_name='制造商'),
        ),
        migrations.AddField(
            model_name='asset',
            name='tags',
