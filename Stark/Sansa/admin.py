...
class AssetAdmin(admin.ModelAdmin):
    ...
    list_display = ('id','asset_type','sn','name','manufactory','management_ip','idc','admin','trade_date')

    inlines = [ServerInline,CPUInline,RAMInline,DiskInline,NICInline]#把表里的东西拿过来
    search_fields = ['sn',]
    list_filter = ['idc','manufactory','business_unit','asset_type']
    # list_filter = ['idc','manufactory','asset_type']
